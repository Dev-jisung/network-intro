...
export default function HeroSection() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[500px] w-full py-20 font-sans">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 w-full max-w-6xl px-6">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 relative w-full max-w-sm">
          ...
          <button
            onClick={() => (window.location.href = "/next-slide")}
            className="group relative flex items-center justify-between w-full max-w-[280px] px-6 py-4 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-2xl font-black text-lg transition-all hover:scale-[1.02] active:scale-[0.98] shadow-2xl overflow-hidden"
          >
